...
@section('content')
    ...
    <center>
        ...
        <div class="mainContent">
            ...
            <script language="javascript">
                $(document).ready(function(e) {
                    $("#lname").keyup(function(e) {
                        ...
                        if (is_TEXT(e.key) == false && is_TEXT($(this).val().substr(-1)) == false) {
            ...
            <!-- Date Picker -->
            <div id="nomad_photo_content" style="display: none;">Изображение лица должно быть четким, лицо и плечи
                фотографируемого находятся во фронтальном положении к объективу фотоаппарата. <br><br>
                Допускается разворот головы до 5 градусов от фронтального положения в любом направлении; <br><br>
                Выражение лица должно быть нейтральным, брови должны иметь нейтральное положение, взгляд должен быть
                направлен прямо в объектив фотоаппарата.<br><br>
                Съемка осуществляется без головных уборов, за исключением женского платка, не закрывающего овал лица и
                плотно облегающего голову. <br><br>
                В случае, если заявитель фотографируется в оптических очках, оправа очков не должна закрывать глаза, а очки
                не должны давать бликов.
                Допускается фотографирование в очках с темными линзами лиц с нарушением зрения; </div>
            <form id="form13" action="/register" method="post"
                ...
                <table cellpadding="4" cellspacing="4">
                    ...
                    <tr>
                        ...
                        <td><select class="inp_2556" id="sex_id" name="gender" required="required">
                    ...
                    <tr>
                        ...
                        <td><select class="inp_2556" id="doc_country" name="country" required="required"
                                onchange="call_doc_type();">
                                <option value="">Select</option>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="doc_number" id="doc_nom" class="inp_2556" required="required"
                                value="" /></td>
                    </tr>
                    <tr>
                        <td><label class="lab_2899">Тип документа</label></td>
                        <td><select class="inp_2556" id="doc_type" name="doc_type"></select></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="padding-top:20px">
                            ...
                            {{-- <input type="button" style="padding:4px;" value="Важная информация по фото"
                                onClick="showMsg('success',$('#nomad_photo_content').html());" /> --}}
                        </td>
                    </tr>
                    <script language="javascript">
                        ...
                        */
                        ...
                        $(document).ready(function(e) {
                            $("#file_id_1_1").change(function() {
                                ...
                                if (fileType != 'png' && fileType != 'jpg' && fileType != 'jpeg' && fileType != 'pdf' &&
                                    ...
                                    showMsg("error", "Файл должен быть в формате .pdf, .doc, .docx, .xls, .xlsx ");
                                    return;
                                }
                                if (fileType == 'png' || fileType == 'jpg' || fileType == 'jpeg') {
                                    if (this.files[0].size < 30000 || this.files[0].size > 4000000) {
                                        showMsg("error",
                                            "Размер вашего файла не соответствует требованиям. Минимальный размер должен составлять 30 КБ, а максимальный размер - 4 МБ."
                                            );
                                        $("#file_id_1_1").val("");
                                        return;
                                    }
                        ...
                        function addfile_id_1File() {
                            ...
                            var str = '<tr id="row_file_id_1_' + window.file_id_1Ctn +
                                ...
                                '">Не выбрано файлов ..</span><label for="file_id_1_' + window.file_id_1Ctn +
                                '" class="label_browse">выбрать...<input type="file" id="file_id_1_' + window.file_id_1Ctn +
                            ...
                            var src = document.getElementById("file_id_1_" + window.file_id_1Ctn);
                            var target = document.getElementById("file_id_1_" + window.file_id_1Ctn + "_preview");
                        ...
                        */
                        ...
                        function addfile_id_2File() {
                            ...
                            var str = '<tr id="row_file_id_2_' + window.file_id_2Ctn +
                                ...
                                '">Не выбрано файлов ..</span><label for="file_id_2_' + window.file_id_2Ctn +
                                '" class="label_browse">выбрать...<input type="file" id="file_id_2_' + window.file_id_2Ctn +
                            ...
                            var src = document.getElementById("file_id_2_" + window.file_id_2Ctn);
                            var target = document.getElementById("file_id_2_" + window.file_id_2Ctn + "_preview");
                            showImage(src, target);
                        }
                        ...
                        */
                        ...
                        function addfile_id_3File() {
                            ...
                            var str = '<tr id="row_file_id_3_' + window.file_id_3Ctn +
                                ...
                                '" class="label_browse">выбрать...<input type="file" id="file_id_3_' + window.file_id_3Ctn +
                            ...
                            var src = document.getElementById("file_id_3_" + window.file_id_3Ctn);
                            var target = document.getElementById("file_id_3_" + window.file_id_3Ctn + "_preview");
                            showImage(src, target);
                        }
                    ...
                    <tr>
                        <td></td>
                        <td><br><button type="submit" class="btn_6655"  />Далее </button></td>
                    </tr>
                </table>
