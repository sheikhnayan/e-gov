...
<center>
    ...
    <div class="mainContent">
                ...
                <tr>
                    ...
                    <td align="right" style="padding-top: 3px;">
                        ...
                        <a href="bank_data.html" target="_blank" style="color:white;text-decoration:none;">Банковские
                            ...
                            <option value="{{route('form2.ru')}}" selected>RU</option>
                            <option value="{{route('form2.en')}}" >EN</option>
                        </select>
                    </td>
                </tr>
            </table>
        ...
        <div class="topBarUnder">
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td align="left" width="40%"><a href="index.html"><img src="{{asset('frontendAsset')}}/images/kyrgyz_emblem6d24.png?n=1"
                                class="logo_8789" height="81" /></a></td>
        ...
        <form id="form2" action="https://ework.e-gov.kg/form2.php?lng=ru" method="post" enctype="multipart/form-data">
            <table cellpadding="4" cellspacing="4">
                <tr>
                    <td><label class="lab_2899">Фамилия представителя</label></td>
                    <td><input type="text" name="pred_lname" id="pred_lname" class="inp_2556" required="required"
                            value="" /></td>
                </tr>
                <tr>
                    <td><label class="lab_2899">Имя представителя</label></td>
                    <td><input type="text" name="pred_fname" id="pred_fname" class="inp_2556" required="required"
                            value="" /></td>
                </tr>
                <tr>
                    <td><label class="lab_2899">Наименование юридического лица</label></td>
                    <td><textarea name="entity_name" id="entity_name" class="area_2556" required="required"></textarea>
                    </td>
                </tr>
                <tr>
                    <td><label class="lab_2899">Номер государственной регистрации</label></td>
                    <td><input type="text" name="gosreg_numb" id="gosreg_numb" class="inp_2556" required="required"
                            value="" /></td>
                </tr>
                <tr>
                    <td><label class="lab_2899">Идентификационный номер налогоплательщика</label></td>
                    <td><input type="text" name="inn_numb" id="inn_numb" class="inp_2556" required="required"
                            value="" /></td>
                </tr>
                <tr>
                    <td><label class="lab_2899">Учредители</label></td>
                    <td><textarea name="entity_founders" id="entity_founders" class="area_2556"
                            required="required"></textarea></td>
                </tr>
                <tr>
                    <td><label class="lab_2899">Вид деятельности </label></td>
                    <td><textarea name="entity_activity_type" id="entity_activity_type" class="area_2556"
                            required="required"></textarea></td>
                </tr>
                <tr>
                    <td><label class="lab_2899">Адрес юридического лица</label></td>
                    <td><textarea name="entity_address" id="entity_address" class="area_2556"
                            required="required"></textarea></td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        <script type="text/javascript"
                            src="https://maps.googleapis.com/maps/api/js?sensor=false&amp;libraries=places&amp;key=AIzaSyDl_KxQnWIEtdtOH7xE4E2UiJ9D2LILTbM"></script>
                ...
                <tr>
                    ...
                    <td><textarea name="entity_actual_address" id="entity_actual_address" class="area_2556"
                            required="required"></textarea></td>
                </tr>
                <tr>
                    <td><label class="lab_2899">Номера телефонов юридического лица</label></td>
                    <td><input type="text" name="entity_phone" id="entity_phone" class="inp_2556" required="required"
                            value="" /></td>
                </tr>
                <tr>
                    <td><label class="lab_2899">Адрес электронной почты </label></td>
                    <td><input type="text" name="email_address" id="email_address" class="inp_2556" required="required"
                            value="" /></td>
                </tr>
                <tr>
                        ...
                        <table class="file_id_10_table">
                            <tr id="row_file_id_10_1">
                                <td align="left" valign="top">
                                    <span class="filename" id="file_id_10_text_1">Не выбрано файлов ..</span>
                                    <label for="file_id_10_1" class="label_browse">выбрать...
                                ...
                                <td align="left" valign="top">
                                    ...
                                    <div onClick="addfile_id_10File();" class="addBox_9339" id="file_id_10Active"
                ...
                <script language="javascript">
                            ...
                            img.onload = function () {
                                ...
                                if (fileType == 'png' || fileType == 'jpg' || fileType == 'jpeg') {
                                    if (width < 300 || width > 5000 || height < 300 || height > 5000) {
                                        ...
                                        $("#file_id_10_1").val("");
                                        $("#file_id_10_text_1").html("Не выбрано файлов ..");
                                        return;
                                    }
                                }
                                checkfile_id_10Plus();
                            ...
                            img.onload = function () {
                                ...
                                if (fileType == 'png' || fileType == 'jpg' || fileType == 'jpeg') {
                                    if (width < 300 || width > 5000 || height < 300 || height > 5000) {
                                        showMsg("error", "The resolution of your image does not meet to requirements. Minimum width of the image should be 300 px, minimum height of the image should be 300px. Maximim width of the image should be 5000 px, maximum height of the image should be 5000px.");
                                        $("#file_id_10_" + id).val("");
                                        $("#file_id_10_text_" + id).html("Не выбрано файлов ..");
                                        return;
                                    }
                                }
                            };
                    ...
                    function addfile_id_10File() {
                        ...
                        var str = '<tr id="row_file_id_10_' + window.file_id_10Ctn + '"><td align="left" valign="top"><span class="filename" id="file_id_10_text_' + window.file_id_10Ctn + '">Не выбрано файлов ..</span><label for="file_id_10_' + window.file_id_10Ctn + '" class="label_browse">выбрать...<input type="file" id="file_id_10_' + window.file_id_10Ctn + '" name="file_id_10_' + window.file_id_10Ctn + '" class="file_upload" /></label></td><td align="left" valign="middle"><img src="{{asset('frontendAsset')}}/images/delete_btn.png" onclick="removefile_id_10File(\'' + window.file_id_10Ctn + '\');" class="addIcon_9339" /></td></tr>';
                ...
                <tr>
                    <td style="padding-top:20px"><label class="lab_2899">Свидетельство о юридической регистрации
                        </label></td>
                    <td style="padding-top:20px">
                        <table class="file_id_8_table">
                            <tr id="row_file_id_8_1">
                                <td align="left" valign="top">
                                    <span class="filename" id="file_id_8_text_1">Не выбрано файлов ..</span>
                                    <label for="file_id_8_1" class="label_browse">выбрать...
                                        <input type="file" id="file_id_8_1" name="file_id_8_1" class="file_upload"
                                            required />
                                    </label>
                                </td>
                                <td align="left" valign="top">
                                    <div class="addBox_disable_9339" id="file_id_8Disabled">Add</div>
                                    <div onClick="addfile_id_8File();" class="addBox_9339" id="file_id_8Active"
                                        style="display:none;">Add</div>
                            ...
                            img.onload = function () {
                                ...
                                if (fileType == 'png' || fileType == 'jpg' || fileType == 'jpeg') {
                                    if (width < 300 || width > 5000 || height < 300 || height > 5000) {
                                        showMsg("error", "The resolution of your image does not meet to requirements. Minimum width of the image should be 300 px, minimum height of the image should be 300px. Maximim width of the image should be 5000 px, maximum height of the image should be 5000px.");
                                        $("#file_id_8_1").val("");
                                        $("#file_id_8_text_1").html("Не выбрано файлов ..");
                                        return;
                                    }
                                }
                                checkfile_id_8Plus();
                            ...
                            img.onload = function () {
                                ...
                                if (fileType == 'png' || fileType == 'jpg' || fileType == 'jpeg') {
                                    if (width < 300 || width > 5000 || height < 300 || height > 5000) {
                                        showMsg("error", "The resolution of your image does not meet to requirements. Minimum width of the image should be 300 px, minimum height of the image should be 300px. Maximim width of the image should be 5000 px, maximum height of the image should be 5000px.");
                                        $("#file_id_8_" + id).val("");
                                        $("#file_id_8_text_" + id).html("Не выбрано файлов ..");
                                        return;
                                    }
                                }
                            };
                ...
                <tr>
                    <td style="padding-top:20px"><label class="lab_2899">Лицензия на осуществление лицензируемой
                            деятельности </label></td>
                    <td style="padding-top:20px">
                        <table class="file_id_11_table">
                            <tr id="row_file_id_11_1">
                                <td align="left" valign="top">
                                    <span class="filename" id="file_id_11_text_1">Не выбрано файлов ..</span>
                                    <label for="file_id_11_1" class="label_browse">выбрать...
                                ...
                                <td align="left" valign="top">
                                    ...
                                    <div onClick="addfile_id_11File();" class="addBox_9339" id="file_id_11Active"
                                        style="display:none;">Add</div>
                ...
                <script language="javascript">
                            ...
                            img.onload = function () {
                                ...
                                if (fileType == 'png' || fileType == 'jpg' || fileType == 'jpeg') {
                                    if (width < 300 || width > 5000 || height < 300 || height > 5000) {
                                        showMsg("error", "The resolution of your image does not meet to requirements. Minimum width of the image should be 300 px, minimum height of the image should be 300px. Maximim width of the image should be 5000 px, maximum height of the image should be 5000px.");
                                        $("#file_id_11_1").val("");
                                        $("#file_id_11_text_1").html("Не выбрано файлов ..");
                                        return;
                                    }
                                }
                                checkfile_id_11Plus();
                            ...
                            img.onload = function () {
                                ...
                                if (fileType == 'png' || fileType == 'jpg' || fileType == 'jpeg') {
                                    if (width < 300 || width > 5000 || height < 300 || height > 5000) {
                                        showMsg("error", "The resolution of your image does not meet to requirements. Minimum width of the image should be 300 px, minimum height of the image should be 300px. Maximim width of the image should be 5000 px, maximum height of the image should be 5000px.");
                                        $("#file_id_11_" + id).val("");
                                        $("#file_id_11_text_" + id).html("Не выбрано файлов ..");
                                        return;
                                    }
                                }
                            };
                    ...
                    function addfile_id_11File() {
                        ...
                        var str = '<tr id="row_file_id_11_' + window.file_id_11Ctn + '"><td align="left" valign="top"><span class="filename" id="file_id_11_text_' + window.file_id_11Ctn + '">Не выбрано файлов ..</span><label for="file_id_11_' + window.file_id_11Ctn + '" class="label_browse">выбрать...<input type="file" id="file_id_11_' + window.file_id_11Ctn + '" name="file_id_11_' + window.file_id_11Ctn + '" class="file_upload" /></label></td><td align="left" valign="middle"><img src="{{asset('frontendAsset')}}/images/delete_btn.png" onclick="removefile_id_11File(\'' + window.file_id_11Ctn + '\');" class="addIcon_9339" /></td></tr>';
                ...
                <tr>
                    ...
                    <td><input type="text" name="login_txt" id="login_txt" class="inp_2556" required="required"
                            value="" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="password" name="password_txt_repeat" id="password_txt_repeat" class="inp_2556"
                            required="required" value="" /></td>
                </tr>
                <tr>
                    <td></td>
                    <td><br><input type="button" value="Далее" class="btn_6655" onclick="form2Submit();" /></td>
                </tr>
            </table>
