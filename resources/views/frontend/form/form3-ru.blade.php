              ...
              <tr>
                  ...
                  <td align="right" style="padding-top: 3px;">
                      ...
                      <select id="langSel">
                        ...
                        <option value="{{route('form3.ru')}} selected">RU</option>
                        <option value="{{route('form3.en')}}" >EN</option>
                    </select>
                  </td>
              </tr>
          </table>	
...
<form id="form3" action="https://ework.e-gov.kg/form3.php?lng=ru" method="post" enctype="multipart/form-data">
  <table cellpadding="4" cellspacing="4">
      ...
      <tr>
          <td></td>
          <td><br><input type="button" value="Далее" class="btn_6655" onclick="form3Submit();" /></td>
      </tr>
  </table>
