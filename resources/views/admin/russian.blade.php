                                ...
                                <form action="{{ route('foreign-update',[$data->id]) }}" method="post">
                                    ...
                                    <table cellpadding="4" cellspacing="4">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea name="dob" id="dob" class="form-control" required="required">{{ $data->dob }}</textarea>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td><label class="lab_2899">Doc Number</label></td>
                                            <td>
                                                <textarea name="doc_number" id="doc_number" class="form-control" required="required">{{ $data->doc_number }}</textarea>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td><label class="lab_2899">Mobile</label></td>
                                            <td><input type="text" name="mobile" value="{{ $data->mobile }}" id="inn_numb" class="form-control" required="required"
                                                 /></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="passport_1" value="{{ $data->passport_1 }}" id="passport_1" class="form-control" required="required"
                                               ...
                                               <tr>
                                            <td><label class="lab_2899"> Passport 2</label></td>
